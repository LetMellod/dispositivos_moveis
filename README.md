...
## Comando Básicos do NPM

Aqui estão alguns comando básicos do NPM (Node Package Manage) que podem ser úteis durante o desenvolvimento de aplicações móveis.
